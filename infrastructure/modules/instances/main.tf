...
resource "aws_instance" "controlplane" {
  ...
  user_data = templatefile("${path.module}/controlplane_userdata.sh", {node_type = "controlplane", region = "${var.region}", discovery_bucket_name = "${var.discovery_bucket_name}", cluster_name = "${var.cluster_name}"})
